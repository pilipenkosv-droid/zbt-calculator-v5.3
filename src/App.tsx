                ...
                {[
                  {
                    ...
                    answer:
                      'Цена складывается из компонентов: база, филиалы, доп. номера WhatsApp, уровень мед. маркетинга, техподдержка. Скидки: период (до −20%) + сеть (−5% с 2 филиалов).',
                  },
                  {
                    question: 'Как считаются квоты?',
                    answer:
                      'Анти‑спам квоты ограничивают отправки по каналам: WhatsApp/SMS/Email — дневные и недельные лимиты. Это защищает доставляемость и рейтинг отправителя.',
                  },
                  {
                  ...
                  <div key={index} className="glass-card">
                    ...
                    >
                      ...
                      <span
                        className={`text-xl transition-transform ${openFaqItem === index ? 'rotate-180' : ''}`}
                      >
                        ▼
                      </span>
                    </button>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h3 className="text-lg font-bold mb-3 text-blue-400">
                      В 3–5 раз больше положительных отзывов
                    </h3>
                    <p className="text-white/80 text-sm">
                  ...
                  <div>
                    <h3 className="text-lg font-bold mb-3 text-orange-400">
                      +14–20% конверсия в повторный приём
                    </h3>
                    <p className="text-white/80 text-sm">
          ...
          <div className="footer-bottom">
            <div className="footer-container">
              ...
              <div className="footer-right">
                <div>
                  <a
                    href="https://zabota.tech/#:~:text=%D0%AE%D1%80%D0%B8%D0%B4%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B0%D1%8F%0A%D0%98%D0%BD%D1%84%D0%BE%D1%80%D0%BC%D0%B0%D1%86%D0%B8%D1%8F"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="footer-link"
                  >
