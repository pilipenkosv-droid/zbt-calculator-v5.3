...
const MobileFAQ: React.FC = () => {
  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      answer: 'Уровни Эконом/Актив/Стандарт/Эксперт различаются глубиной сценариев, аналитики и приоритета задач: от базовой помощи и ежемесячного отчёта до стратегических сессий и персонального менеджера. В Стандарт — до 40 активных сценариев без ограничений по типам, с рекомендованным распределением (сервисные, обратная связь/NPS, удержание/возврат, лояльность, персональные акции) и регулярным аудитом под цели роста; доступны A/B-эксперименты и «овертайм»-услуги.'
    }
  ];
